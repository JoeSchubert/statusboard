...
public class TableColumnAdjuster implements PropertyChangeListener, TableModelListener {
     ...
     */
    public TableColumnAdjuster(JTable table, boolean headers) {
        this(table, 6, headers);
    }

    /*
	 *  Specify the table and spacing
     */
    public TableColumnAdjuster(JTable table, int spacing, boolean headers) {
        this.table = table;
        this.spacing = spacing;
        setColumnHeaderIncluded(headers);
        setColumnDataIncluded(headers);
